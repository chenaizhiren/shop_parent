...
public class RedisConst {
    ...
    public static final Long CART_TOTAL_SIZE = 100L;
    public static final Long CART_SINGLE_SIZE = 10L;


    public static final Object RETRY_KEY = "retry:key";
    public static final Long RETRY_COUNT = 5L;
